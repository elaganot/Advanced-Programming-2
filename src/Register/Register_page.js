...
function Register_Page({ contacts, setContacts, setRegisteredName, setUserImage }) {
    ...
    function handleSubmit(event) {
        ...
        if (missingFields) {
            ...
            const newContact = { userName: userName, password: password, name: name, image: photo, myFriends: [] };
    ...
    return (
        ...
        <div className="register-container">
            <div className="register-content">
                ...
                <input type="text" placeholder={isFilePicked ? (photo) : ("No file chosen")}></input>
